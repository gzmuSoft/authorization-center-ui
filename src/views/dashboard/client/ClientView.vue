  ...
  v-sheet.clientView(tile)
    v-form(ref="form")
      v-row
        ...
        //v-col(cols="12", md="6")
          v-text-field(v-model="res.clientSecret", ref="clientSecret", :label="$t('entity.client.clientSecret')",
            //:hint="$t('entity.client.tip.clientSecret')", persistent-hint,
            counter="100", :rules="[required('entity.client.clientSecret'), maxLength(100)]")
        v-col(cols="12", md="6")
